...
<div class="invoice-container">
    ...
    <div class="top-section" style="display:block; margin-bottom:20px;">
        ...
        @foreach ($groupedData as $customerCode => $items)
            @foreach ($items as $item)
                @php
                    ...
                    $total = $totalNumber * $item->product->unit_price;
                @endphp
                <tr>
                    <td>{{ $itemCode }}</td>
                    <td class="text-left">
    ...
    <div class="amount-section">
        <div><span class="amount-words">TOTAL AMOUNT IN THE WORDS: </span>{{ $amountInWords }}</div>
